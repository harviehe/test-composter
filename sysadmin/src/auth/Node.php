<?php
namespace Sysadmin\auth;

use Doctrine\Common\Annotations\AnnotationReader;
use Doctrine\Common\Annotations\AnnotationRegistry;
use Doctrine\Common\Annotations\FileCacheReader;
use SysAdmin\annotation\ControllerAnnotation;
use SysAdmin\annotation\NodeAnotation;
            ...
            foreach ($controllerList as $controllerFormat => $controller) {
                ...
                foreach ($methods as $method) {
                    ...
                    if (!empty($nodeAnnotation) && !empty($nodeAnnotation->title)) {
                        ...
                        $actionList[] = [
                            'node'    =>$this->dirName . $controllerFormat . '/' . $method->name,
                            'title'   => $actionTitle,
                            'is_auth' => $actionAuth,
                            'type'    => 2,
                        ];
                ...
                if (!empty($actionList)) {
                    ...
                    $nodeList[]           = [
                        'node'    => $this->dirName . $controllerFormat,
