...
namespace SysAdmin\curd;

use SysAdmin\curd\exceptions\TableException;
use SysAdmin\tool\CommonTool;
...
class BuildCurd
{
    ...
    public function setTable($table)
    {
        ...
        try {
            ...
            // 获取表名注释
            $tableSchema = Db::query("SELECT table_name,table_comment FROM information_schema.TABLES WHERE table_schema = 'sysadmin' AND table_name = '{$this->tablePrefix}{$this->table}'");
