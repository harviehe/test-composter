...
namespace SysAdmin\upload;

use SysAdmin\upload\driver\Alioss;
use SysAdmin\upload\driver\Local;
use SysAdmin\upload\driver\Qnoss;
use SysAdmin\upload\driver\Txcos;
use think\File;

/**
 * 上传组件
 * Class Uploadfile
 * @package SysAdmin\upload
 */
class Uploadfile
{
